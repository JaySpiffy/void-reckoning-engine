...
RESEARCH_COST_THRESHOLD = 500
FLEET_COMMISSION_THRESHOLD = 1500
FLEET_COMMISSION_COST = 1000
CONSTRUCTION_REQ_THRESHOLD = 600
...
ACTIVE_FACTION_UNIT_CAP = 200 # [PHASE 11] Per-faction deployment limit
SUPPRESSED_THRESHOLD = 25.0
PINNED_THRESHOLD = 75.0
SUPPRESSION_RECOVERY_BONUS = 5.0

# Victory
VICTORY_PLANET_THRESHOLD = 0.75
