...
ECON_RESERVE_MIN = 550
ECON_RESERVE_TARGET = 600
ECON_CONSTRUCTION_BUDGET_MIN = 1000
...
RECOVERY_RECRUITMENT_MILD = 0.2     # Recruitment budget in mild RECOVERY
RECOVERY_RECRUITMENT_MODERATE = 0.1  # Recruitment budget in moderate RECOVERY
